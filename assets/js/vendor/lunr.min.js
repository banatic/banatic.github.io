...
! function() {
    var e = function(t) {
        var r = new e.Builder;
        //return r.pipeline.add(e.stopWordFilter, e.stemmer), r.searchPipeline.add(e.stemmer), t.call(r, r), r.build()
    ...
    e.version = "2.3.6", e.utils = {}, e.utils.warn = function(e) {
            ...
            return e.update(function(e) {
                return e.replace(/^[^ㄱ-ㅎ|가-힣|a-z|A-Z|0-9|\*]+/, "").replace(/[^ㄱ-ㅎ|가-힣|a-z|A-Z|0-9|\*]+$/, "")
            })
